...
- [Plusieurs langues](plusieurs-langues.md) — **une demande étrangère n'est plus exécutée de travers en silence** : 26 pannes silencieuses sur 345 devenues 1, sans un exemple nouveau ni un mot traduit, et sans rien changer pour le français. Pourquoi l'entrée passe avant la sortie, pourquoi 11 demandes étrangères confirmées suffisaient à faire doubler les pannes, et le seul des sept travaux qui a été refusé après mesure.
